...
// return true to allow dragging on 
// for the current layer. this is only called
// for ids with mapped icons and with editing
// permission, (or if showLoginDrag=true)
function canDragLayer(layerId){
return true
}
// layer is a map layer.
function formatLayerElement(element, layer){
}
// format the layer popover (hover over tip).
function formatPopoverScript(popover, layerMetadata){
/**
...
// format the legend container element.
function formatLegendScript(element){
/**
...
// call defaultBehaviorFn() to simply open the marker wizard
// otherwise add your custom logic
function onDragEndScript(latlng, iconUrl, defaultBehaviorFn){
var userIsGuest=<?php 
